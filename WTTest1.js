...
var i=0;
function myfun(){   
    var a=['#6738DC','#61BBFE','FDA62B','#00F0FF'];
...
var bgH=document.getElementById('hed');
bgH.addEventListener('mouseover',bgchange);
function bgchange(){
    document.getElementById('hed').style.backgroundColor='green';
    document.getElementById('hed1').style.color='yellow';
}
bgH.addEventListener('mouseout',bgchange1);
function bgchange1(){
